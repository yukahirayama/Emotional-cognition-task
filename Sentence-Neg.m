...
try
  ...
  %画像の読み込み
Neg1 = imread('Neg1.png');
Neg2 = imread('Neg2.png');
Neg3 = imread('Neg3.png');
Neg4 = imread('Neg4.png');
Neg5 = imread('Neg5.png');
Neg6 = imread('Neg6.png');

Neg1 = Screen('MakeTexture', win, Neg1);
Neg2 = Screen('MakeTexture', win, Neg2);
Neg3 = Screen('MakeTexture', win, Neg3);
Neg4 = Screen('MakeTexture', win, Neg4);
Neg5 = Screen('MakeTexture', win, Neg5);
Neg6 = Screen('MakeTexture', win, Neg6);
...
r=random_number = 1.5 + rand() * (3.5 - 2.5);
  ...
  %FaceSenの表示
  Screen('DrawTexture', win,Neg1,[],rect);
  Screen('Flip', win);
  WaitSecs(4);
  ...
  %FaceSenの表示
  Screen('DrawTexture', win,Neg2,[],rect);
  Screen('Flip', win);
  WaitSecs(4);
  ...
  %FaceSenの表示
  Screen('DrawTexture', win,Neg3,[],rect);
  Screen('Flip', win);
  WaitSecs(4);
  ...
  %FaceSenの表示
  Screen('DrawTexture', win,Neg4,[],rect);
  Screen('Flip', win);
  WaitSecs(4);
  ...
  %FaceSenの表示
  Screen('DrawTexture', win,Neg5,[],rect);
  Screen('Flip', win);
  WaitSecs(4);
  ...
  %FaceSenの表示
  Screen('DrawTexture', win,Neg6,[],rect);
  Screen('Flip', win);     
  WaitSecs(4);
