...
Pos3 = imread('Pos3.png');
Pos4 = imread('Pos4.png');
Pos5 = imread('Pos5.png');
Pos6 = imread('Pos6.png');

Pos1 = Screen('MakeTexture', win, Pos1);
Pos2 = Screen('MakeTexture', win, Pos2);
Pos3 = Screen('MakeTexture', win, Pos3);
Pos4 = Screen('MakeTexture', win, Pos4);
Pos5 = Screen('MakeTexture', win, Pos5);
Pos6 = Screen('MakeTexture', win, Pos6);
...
r=random_number = 1.5 + rand() * (3.5 - 2.5);
  ...
  %FaceSenの表示
  Screen('DrawTexture', win,Pos1,[],rect);
  Screen('Flip', win);
  WaitSecs(4);
  ...
  %FaceSenの表示
  Screen('DrawTexture', win,Pos2,[],rect);
  Screen('Flip', win);
  WaitSecs(4);
  ...
  %FaceSenの表示
  Screen('DrawTexture', win,Pos3,[],rect);
  Screen('Flip', win);
  WaitSecs(4);
  ...
  %FaceSenの表示
  Screen('DrawTexture', win,Pos4,[],rect);
  Screen('Flip', win);
  WaitSecs(4);
  ...
  %FaceSenの表示
  Screen('DrawTexture', win,Pos5,[],rect);
  Screen('Flip', win);
  WaitSecs(4);
  ...
  %FaceSenの表示
  Screen('DrawTexture', win,Pos6,[],rect);
  Screen('Flip', win);     
  WaitSecs(4);
